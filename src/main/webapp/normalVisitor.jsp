...
<body>
    ...
    <div class="container">
        <h1 class="mt-4">Add Normal Visitor</h1>
        <form action="addNormalVisitor" method="post">
            ...
            <button type="submit" class="btn btn-primary">Send Request to the Resident</button>
        </form>
    </div>
    <br><br>
